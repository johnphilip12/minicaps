<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <img src="{{ asset('images/q.jpg') }}" alt="logo" class="img-fluid rounded-circle img-responsive" style="width: 30px; margin-left: 50px">
    <h5 class="p-2">Motors App</h5>
    <ul class="navbar-nav">
        @role('writer')
        ...
        <li class="nav-item">
          <a class="nav-link text-dark" href="{{ '/car' }}">Motors</a>
        </li>
        <li class="nav-item">
